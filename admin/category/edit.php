            ...
            <section class="flex flex-col mx-4">
                ...
                <section class="xs:flex justify-between items-center rounded my-3 py-2">
                    <section class="text-center xs:text-right space-y-2">
                        ...
                        <div class="text-xs md:text-sm text-gray-400 dark:text-gray-500">شما در حال ایجاد ویرایش دسته بندی
                            هستید</div>
                    </section>
                    <section class="flex justify-around">
                        <a href="./category-index.html" class="btn btn-red rounded flex space-x-1 space-x-reverse">
                ...
                <section class="bg-white dark:bg-[#22272E]  p-4">
                    <form action="<?= url('admin/category/update.php') ?>" method="post">
                            ...
                            <section class="grid grid-cols-6 gap-6">
                                <section class="col-span-6 sm:col-span-3">
                                    <label class="mb-2 text-sm font-bold text-gray-700 dark:text-gray-400">عنوان
                                        دسته</label>
                                    <input type="text" name="name" value="<?= $category['name'] ?>" class="form-control" placeholder="عنوان ">
                                    <input type="hidden" name="id" value="<?= $category['id'] ?>" class="form-control" placeholder="عنوان ">
                                </section>
                            </section>
