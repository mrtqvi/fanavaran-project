            ...
            <section class="flex flex-col mx-4">
                ...
                <section class="xs:flex justify-between items-center rounded my-3 py-2">
                    <section class="text-center xs:text-right space-y-2">
                        ...
                        <div class="text-xs md:text-sm text-gray-400 dark:text-gray-500">شما در حال ایجاد خبر جدید
                            هستید</div>
                    </section>
                    <section class="flex justify-around">
                        <a href="<?= url('admin/news/index.php') ?>"
                            class="btn btn-red rounded flex space-x-1 space-x-reverse">
                ...
                <section class="bg-white dark:bg-[#22272E]  p-4">
                    <form action="<?= url('admin/news/store.php') ?>" method="post" enctype="multipart/form-data">
                            ...
                            <section class="grid grid-cols-6 gap-6">
                                <section class="col-span-6 sm:col-span-3">
                                    <label class="mb-2 text-sm font-bold text-gray-700 dark:text-gray-400">عنوان
                                        خبر</label>
                                    <input type="text" name="title" value="<?= $news->title ?>" class="form-control" placeholder="عنوان ">
                                </section>
                                <section class="col-span-6 sm:col-span-3">
                                    <label for="large-input"
                                        class="mb-2 text-sm font-bold text-gray-700 dark:text-gray-400">دسته
                                        بندی خبر</label>
                                    <select type="text" name="category_id" required id="large-input" class="form-control">
                                        <option value="">
                                        ...
                                        foreach ($categories as $category) {
                                            ?>
                                            <option value="<?= $category['id'] ?>" <?php if ($category['id'] == $news->category_id) echo 'selected' ?> >
                                                <?= $category['name'] ?>
                                            </option>
                                        <?php } ?>
                                    </select>
                                ...
                                <section class="col-span-6">
                                    <label class="mb-2 text-sm font-bold text-gray-700 dark:text-gray-400">متن
                                        خبر</label>
                                ...
                                <section class="col-span-6 sm:col-span-3">
                                    <label for="large-input"
                                        class="mb-2 text-sm font-bold text-gray-700 dark:text-gray-400">وضعیت
                                        انتشار</label>
