                ...
                <section class="overflow-x-auto">
                    <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                        ...
                        <tbody
                            ...
                            $query = "SELECT news.*, categories.name AS category_name, users.first_name, users.last_name
                                     FROM news 
                            ...
                            foreach ($results as $result) {
                                ...
                                <tr>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-center">
                                        <small><?= $result->category_name ?></small>
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap text-center">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-center">
                                        <small><?= $result->is_publish == "0" ? "پیش نویس" : "منتشر شده" ?></small>
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap text-center">
                                        <small><?= date("Y/m/d", strtotime($result->created_at)) ?></small>
                                    </td>
                                    <td class="flex space-x-2 space-x-reverse justify-center px-6 py-4 whitespace-nowrap">
                                        <a href="<?= url("admin/news/edit.php?id={$result->id}") ?>"
                                        ...
                                        <form action="<?= url('admin/news/destroy.php') ?>" method="post">
