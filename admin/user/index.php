                    ...
                    <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                        ...
                        <tbody
                            ...
                            <tr>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-center">چه نوع ارز دیجیتالی بخریم</td>
                                <td class="px-6 py-4 whitespace-nowrap  text-center">بازار مالی</td>
                                ...
                                <td class="flex space-x-2 space-x-reverse justify-center px-6 py-4 whitespace-nowrap">
                                    <a href="#" class="bg-opacity-30 bg-blue-700 p-1 rounded">
                                    ...
                                    <a href="#" class="bg-opacity-30 bg-red-700 p-1 rounded">
                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                            stroke-width="1.5" stroke="currentColor"
